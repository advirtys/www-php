			...
			<main class="content">
                            <div id="contentt">
                                <div>
                                    ...
                                    <form  action="addarticlesaction.php" method="POST">
                                        <h1 style="margin-bottom: 10px; 
    font: 16px Arial, sans-serif; font-weight: bold;">Добавить статью</h1> 
            <table id="articles">                
                <tr><td><h5>Название:</h5></td><td>
            <input name="title"/></td></tr>
                <tr><td><h5>Дата:</h5></td><td><input name="date" type="date"/></td></tr>
                <tr><td><h5>Рубрика:</h5></td><td><input name="rubric"/></td></tr>
                <tr><td><h5>Автор:</h5></td><td><input name="author"/></td></tr>';
echo <<<SETTAG
        <tr><td></td><td>
...
SETTAG;
echo ' <tr><td></td><td><textarea id="text" name="text"></textarea></td></tr>
