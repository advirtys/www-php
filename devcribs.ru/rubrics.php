...
<div class="wrapper">
	...
	<header class="header">
		 <p><span id="green">/**<br>* Created by max on 2015-08-11 <br>**/</span><br>
                    ...
                    <span id="white3">System.</span><span id="purple">out</span><span id="white">.println(</span><span id="green">"Добро пожаловать в рубрику: <?php echo $rubric ?>"</span><span id="white">)</span><span id="orange">;</span></p>
	</header><!-- .header-->
...
?>
    ...
    $start = $page * $num - $num; 
                            ...
                            $result = mysql_query("SELECT * FROM articles WHERE rubric = '$rubric' LIMIT $start, $num");
    while ($col = mysql_fetch_array($result)){
       $id = $col['id']; 
       $title = $col['title'];       
